...
//Función que guarda en aux la dirección del nodo que contiene inf
// @param A Arbol binario
// @param inf telemento a buscar
// @param aux dirección del nodo que contiene inf (aux=NULL si no se encuentra inf en A
